		...
		<div class="row">
			<div
				...
				<iframe
					allowfullscreen=""
					frameborder="0"
					src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d985.7163819986274!2d115.16184037267226!3d-8.798701988527364!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd244c13ee9d753%3A0x6c05042449b50f81!2sPoliteknik%20Negeri%20Bali!5e0!3m2!1sid!2sid!4v1732005789620!5m2!1sid!2sid"
					width="100%"
					height="100%"></iframe>
			</div>
			<div
				...
				<div style="box-shadow: 0px 0px 12px 9px #7b7b7b15">
					<form class="p-3 p-xl-4" method="post">
						...
						<div class="mb-3">
							<label class="form-label" for="name">Judul</label><input
								id="name-2"
								class="form-control"
								type="text"
								name="judul" />
						...
						<div class="mb-3">
							<label class="form-label" for="name">Telp</label><input class="form-control" type="number" name="Telp" />
						</div>
						<div class="mb-3">
							<label class="form-label" for="message">Message</label><textarea
								class="form-control"
								id="message"
								name="message"
								rows="6"></textarea>
