    ...
    <div class="container py-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
            <?php foreach ($projects as $project) : ?>
                <div class="col mb-4">
                    <div><a href="<?=$project['url']?>"><img class="rounded img-fluid shadow w-100 fit-cover" src="https://res.cloudinary.com/dnppmhczy/image/upload/v1736507757/<?= $project['photo'] ?>" style="height: 250px;"></a>
